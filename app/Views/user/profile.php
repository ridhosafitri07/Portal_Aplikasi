...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page-header-left p { color: var(--text-muted); font-size: .9rem; transition: color .3s; }
        ...
        .alert-success { background: linear-gradient(135deg, #dcfce7, #f0fdf4); border: 1.5px solid #86efac; color: #15803d; }
        .alert-error   { background: linear-gradient(135deg, #fee2e2, #fef2f2); border: 1.5px solid #fca5a5; color: #dc2626; }

        .alert-close { margin-left: auto; background: none; border: none; color: inherit; cursor: pointer; opacity: .6; font-size: 1rem; transition: opacity .2s; }
        ...
        .profile-meta { display: flex; gap: 24px; margin-top: 16px; flex-wrap: wrap; }
        ...
        .profile-meta-item .val {
            ...
            color: var(--meta-val-color); transition: color .3s;
        }

        .profile-meta-item .lbl { font-size: .75rem; color: var(--meta-lbl-color); margin-top: 2px; transition: color .3s; }
        ...
        .card-panel-title { font-family: 'Space Grotesk', sans-serif; font-size: 1rem; font-weight: 700; color: var(--text-primary); transition: color .3s; }
        .card-panel-subtitle { font-size: .78rem; color: var(--text-muted); margin-top: 2px; transition: color .3s; }
        ...
        .strength-bar { flex: 1; height: 3px; border-radius: 2px; background: var(--field-border); transition: background .3s; }
        ...
        .match-msg { margin-top: 6px; font-size: .78rem; font-weight: 500; min-height: 18px; display: flex; align-items: center; gap: 5px; }

        .form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }

        .form-divider { height: 1px; background: var(--form-divider); margin: 24px 0; transition: background .3s; }
        ...
        .btn-submit .spinner { display: none; width: 16px; height: 16px; border: 2px solid rgba(255,255,255,0.3); border-top-color: white; border-radius: 50%; animation: spin .6s linear infinite; }
        @keyframes spin { to { transform: rotate(360deg); } }

        .theme-section { padding: 8px 0; }
        .theme-label-title { font-size: .8rem; font-weight: 600; color: var(--label-color); text-transform: uppercase; letter-spacing: 0.3px; margin-bottom: 14px; transition: color .3s; }
        ...
        .theme-card.selected { border-color: var(--blue-600); box-shadow: 0 0 0 3px rgba(37,99,235,0.15); }
        ...
        .theme-preview-box { height: 80px; display: flex; padding: 10px; gap: 6px; }
        ...
        .theme-card:first-child .theme-card-label { text-align: center; padding: 8px; font-size: .78rem; font-weight: 600; background: white; color: #64748b; }
        .theme-card:first-child.selected .theme-card-label { color: var(--blue-600); }
        .theme-card:last-child .theme-card-label  { text-align: center; padding: 8px; font-size: .78rem; font-weight: 600; background: #1e2535; color: #94a3b8; }
        .theme-card:last-child.selected .theme-card-label { color: #60a5fa; }

        .theme-note { font-size: .75rem; color: var(--text-muted); margin-top: 12px; transition: color .3s; }

        .info-item { display: flex; align-items: center; gap: 14px; padding: 14px 0; border-bottom: 1px solid var(--info-item-border); transition: border-color .3s; }
        .info-item:last-child { border-bottom: none; }

        .info-icon { width: 36px; height: 36px; border-radius: 9px; background: var(--info-icon-bg); display: flex; align-items: center; justify-content: center; color: var(--info-icon-color); font-size: .9rem; flex-shrink: 0; transition: background .3s, color .3s; }

        .info-text { flex: 1; }
        .info-text .key { font-size: .75rem; color: var(--text-muted); transition: color .3s; }
        .info-text .val { font-size: .88rem; font-weight: 600; color: var(--text-primary); margin-top: 2px; transition: color .3s; }

        .security-tip { background: var(--tip-bg); border: 1.5px solid var(--tip-border); border-radius: 12px; padding: 14px 16px; display: flex; gap: 12px; align-items: flex-start; transition: background .3s, border-color .3s; }
        ...
        .logout-card-info { display: flex; align-items: center; gap: 16px; }
        ...
        .modal-overlay { position: fixed; inset: 0; background: rgba(5,10,25,0.65); backdrop-filter: blur(10px); z-index: 2000; display: flex; align-items: center; justify-content: center; opacity: 0; pointer-events: none; transition: opacity .3s; }
        .modal-overlay.show { opacity: 1; pointer-events: all; }

        .modal-box { background: var(--modal-bg); border-radius: 24px; padding: 40px 36px; max-width: 420px; width: 90%; text-align: center; box-shadow: 0 32px 80px rgba(5,10,25,0.4); transform: scale(.9) translateY(20px); transition: transform .3s cubic-bezier(0.34,1.56,0.64,1), background .3s; border: 1px solid var(--border-color); }
        .modal-overlay.show .modal-box { transform: scale(1) translateY(0); }

        .modal-icon { width: 70px; height: 70px; background: var(--modal-icon-bg); border-radius: 20px; display: flex; align-items: center; justify-content: center; font-size: 2rem; color: #ef4444; margin: 0 auto 22px; transition: background .3s; }

        .modal-box h3 { font-family: 'Space Grotesk', sans-serif; font-size: 1.3rem; color: var(--text-primary); margin-bottom: 10px; transition: color .3s; }
        .modal-box p  { font-size: .9rem; color: var(--text-muted); margin-bottom: 28px; transition: color .3s; }

        .modal-btns { display: flex; gap: 12px; }
        .modal-btns button { flex: 1; padding: 13px; border: none; border-radius: 12px; font-size: .9rem; font-weight: 600; cursor: pointer; transition: all .2s; font-family: 'DM Sans', sans-serif; }

        .btn-cancel { background: var(--cancel-bg); color: var(--cancel-color); }
        .btn-cancel:hover { background: var(--cancel-hover); }

        .btn-confirm { background: linear-gradient(135deg, #ef4444, #f87171); color: white; box-shadow: 0 4px 12px rgba(239,68,68,0.3); }
        ...
        @media (max-width: 768px) {
            ...
            .profile-meta { justify-content: center; gap: 20px; }
            ...
            .page-header-left h1 { font-size: 1.6rem; }
            ...
            .btn-logout-main { width: 100%; justify-content: center; }
        }
        ...
        @media (max-width: 480px) {
            ...
            .profile-meta-item .val { font-size: 1rem; }
        }
    </style>
</head>
<body>
...
<nav class="bottom-nav">
    <div class="bottom-nav-inner">
        ...
        <a href="<?= base_url('user/profile') ?>" class="bottom-nav-item active">
            <i class="bi bi-person-fill"></i>
            <span>Profil</span>
        </a>
...
<div class="main">
                    ...
                    <form action="<?= base_url('user/profile/password') ?>" method="POST" id="formPassword">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-toggle">
                                <input type="password" name="old_password" id="oldPwd" class="form-input" placeholder="Masukkan password lama">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="input-with-toggle">
                                    <input type="password" name="new_password" id="newPwd" class="form-input" placeholder="Password baru">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-toggle">
                                    <input type="password" name="confirm_password" id="confirmPwd" class="form-input" placeholder="Ulangi password baru">
            ...
            <div class="card-panel">
                ...
                <div class="card-panel-body">
                    <div class="theme-section">
                        ...
                        <p class="theme-note">Tersimpan di browser. Tema berlaku di semua halaman portal.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="logout-section fade-in">
        <div class="logout-card">
            <div class="logout-card-info">
                <div class="logout-card-icon">
                    <i class="bi bi-box-arrow-right"></i>
                </div>
                <div class="logout-card-text">
                    <h3>Keluar dari Akun</h3>
                    <p>Sesi kamu akan berakhir dan kamu perlu login kembali untuk mengakses portal.</p>
                </div>
            </div>
            <button class="btn-logout-main" onclick="showLogoutModal()">
                <i class="bi bi-box-arrow-right"></i>
                Keluar
            </button>
        </div>
...
(function() { applyTheme(localStorage.getItem('portal_theme') || 'light'); })();
...
newPwd.addEventListener('input', function() {
    ...
    if (val.length > 0) { pwdStrength.classList.add('show'); updateStrengthBars(strength); }
    else { pwdStrength.classList.remove('show'); }
    checkMatch();
});
...
window.addEventListener('scroll', () => {
    ...
    nav.style.boxShadow = window.scrollY > 10 ? '0 1px 40px rgba(37,99,235,0.14)' : '';
});
</script>
</body>
</html>